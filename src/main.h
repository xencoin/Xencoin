...
static const int64 MAX_MONEY = 2100000000 * COIN; // Xencoin: maximum of 2100M coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 720 / 250; // Xencoin: 720 blocks found a day. Priority cutoff is 1 xencoin day / 250 bytes.
    }
